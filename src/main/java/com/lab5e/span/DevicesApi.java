...
import com.lab5e.span.model.SendMessageResponse;
...
public class DevicesApi {
     ...
     */
    public SendMessageResponse sendMessage(String collectionId, String deviceId, SendMessageRequest body) throws ApiException {
        ApiResponse<SendMessageResponse> localVarResp = sendMessageWithHttpInfo(collectionId, deviceId, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SendMessageResponse> sendMessageWithHttpInfo(String collectionId, String deviceId, SendMessageRequest body) throws ApiException {
    ...
    /**
     * Send message to a device. (asynchronously)
     * Send a message to the device
     * @param collectionId  (required)
     * @param deviceId  (required)
     * @param body  (required)
     ...
     */
    public okhttp3.Call sendMessageAsync(String collectionId, String deviceId, SendMessageRequest body, final ApiCallback<SendMessageResponse> _callback) throws ApiException {
    ...
    /**
     * Update device. The device can be moved from one collection to another by setting the collection ID field to the new collection. You must have administrative access to both collections. (asynchronously)
     * Update device. The device can be moved from one collection to another by setting the collection ID field to the new collection. You must have administrative access to both collections.
     * @param existingCollectionId  (required)
     * @param deviceId  (required)
     * @param body  (required)
