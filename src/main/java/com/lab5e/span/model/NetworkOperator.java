 ...
 */
@ApiModel(description = "Operator holds information on the network operator. There might be several operators involved; one operator is running the network your devices are connected to and the SIM card in your device belongs to a different operator.")
...
public class NetworkOperator {
  ...
  **/
  ...
  @ApiModelProperty(value = "The Mobil Country Code for the operator.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(mcc, mnc, country, network);
  }
